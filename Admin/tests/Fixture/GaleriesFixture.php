 ...
 *
 */
class GaleriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'galerie_ibfk_1' => ['type' => 'foreign', 'columns' => ['projet_id'], 'references' => ['projets', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2015-09-07 18:42:35',
            'modified' => '2015-09-07 18:42:35'
        ],
    ];
}
